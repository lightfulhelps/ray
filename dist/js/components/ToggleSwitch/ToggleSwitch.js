...
var ToggleSwitch = function ToggleSwitch(_ref) {
  var checked = _ref.checked,
      ...
      _ref$id = _ref.id,
      id = _ref$id === void 0 ? 'toggle-switch' : _ref$id,
  ...
  var classes = (0, _classnames["default"])(className, 'custom-control custom-switch', labelAlign && labelAlign !== 'right' && "custom-switch-".concat(labelAlign));
