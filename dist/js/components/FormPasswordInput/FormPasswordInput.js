...
function (_React$Component) {
  ...
  function FormPasswordInput() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FormPasswordInput)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FormPasswordInput, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["className", "onChange", "onBlur", "value", "id", "isInvalid", "isValid", "name", "placeholder", "size"]);

      var hidePassword = this.state.hidePassword;
      var classes = (0, _classnames["default"])(className, 'form-control');
...
_defineProperty(FormPasswordInput, "defaultProps", {
  name: 'password'
});

var _default = FormPasswordInput;
