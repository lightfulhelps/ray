...
const ResourceCard = ({
  ...
  const classes = classNames(className, 'resource-card', 'card p-1 rounded shadow h-100 bg-gray-900 text-decoration-none');
  const style = {};
  ...
  return <Tag {...other} className={classes} style={style}>
      <div className="d-flex align-items-center mb-2">
        <div className="rounded-circle d-flex align-items-center justify-content-center mr-1 flex-shrink-0" style={{ width: '24px', height: '24px', background: 'rgba(255, 255, 255, 0.2)' }}>
