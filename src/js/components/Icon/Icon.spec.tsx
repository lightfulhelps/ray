...
describe('<Icon />', () => {
  ...
  it('should not update fill color on hover if hoverColor is not provided', () => {
    const {
      wrapper
    } = setup({ color: 'red', hoverColor: null });
  ...
  it('should update fill color on hover if hoverColor is provided', () => {
    const {
      wrapper
    } = setup({ color: 'red', hoverColor: 'blue' });
