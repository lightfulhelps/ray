...
describe('<InspirationPostCard />', () => {
  ...
  it('should optionally display inspirationActions', () => {
    const {
      wrapper
    } = setup({ inspirationActions: [{ icon: 'follow' }] });
  ...
  it('should handle the inspirationActions prop', () => {
    ...
    const inspirationActions = wrapper.find('.inspiration-post-card__inspiration-actions').find(Icon);
