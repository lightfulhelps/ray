...
stories.add('Default', () => {
  const steps = [{ label: 'Step one', value: 1, onClick: action('clicked 1') }, { label: 'Step two', value: 2, onClick: action('clicked 2') }, { label: 'Step three', value: 3 }];
  ...
  return <Container>
      ...
      <Button className="mt-2" theme="dark" onClick={() => store.set({ step: store.get('step') + 1 })}>
        Next
      </Button>
    </Container>;
});