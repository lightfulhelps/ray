...
stories.add('Default', () => <Container>
    ...
    <Row>
      ...
      }, { icon: 'repost', isActive: false, theme: 'gray-500' }, { icon: 'reply', isActive: false, theme: 'gray-500' }, { icon: 'create', isActive: false, theme: 'gray-500' }]} />
      </Col>
    </Row>
  </Container>);

stories.add('Ghost', () => <Container>
